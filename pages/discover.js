...
export default function Discover() {
  ...
  return (
    <>
      <div className="search" style={{ display: 'flex', justifyContent: 'center' }} id="discover-top">
        <div className="search-div" style={{ width: '30%', maxWidth: '600px' }}>
          <br />
          <div>
            <Form
              className="search-bar"
              style={{
                marginTop: '20px', marginBottom: '20px', position: 'relative', textAlign: 'center',
              }}
            >
              <OverlayTrigger
                placement="bottom"
      ...
      >
        <a href="#discover-top">
          <button aria-label="scroll-to-send" type="button" style={{ border: 'none', backgroundColor: 'inherit' }}>
